...
sample_to_annotate <- anti_join(unnested_1000_sample,gold_323, by = c("row_id_new","location","location_number","Sentence"))
...
test <- semi_join(sample_to_annotate_400,gold_323, by = c("row_id_new","location","location_number","Sentence"))
