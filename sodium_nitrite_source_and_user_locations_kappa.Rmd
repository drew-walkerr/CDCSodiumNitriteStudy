...
sample_to_annotate <- anti_join(unnested_1000_sample,gold_standard_multi_100_sentences, by = "row_id_new")
...
sample_to_annotate_sudeshna_200 <- sample_to_annotate_400 %>% 
  head(n = 200)
write_csv(sample_to_annotate_sudeshna_200,"cdc_sn_sudeshna_200_annotation_round_2.csv")
# Drew
